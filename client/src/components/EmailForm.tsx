...
const animationVariants = {
    initial: {
        opacity: 0,
        x: -100, // Starting position from the left side
    },
    animate: {
        opacity: 1,
        x: 0, // Ending position at the center of the screen
    },
};
...
const hoverVariants = {
    ...
    hover: {
        scale: 1.1, // Zoomed out scale
        transition: {
            duration: 0.3, // Transition duration
            ease: 'easeOut', // Easing function (optional)
        },
    },
};
function EmailForm() {
