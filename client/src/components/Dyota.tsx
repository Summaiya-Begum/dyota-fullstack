...

      {
        isLoading ? (
          ...
          : (
            <div className="h-full">
              <div className=''>
                <img src="https://img.freepik.com/free-psd/fashion-banner-design-template_23-2149072746.jpg?w=1060&t=st=1660568902~exp=1660569502~hmac=39e55eeccd764da667826fb179a83442ba0935b0213d5880f0c72f2199c3d3c1" alt="banner" className="hidden md:block m-auto w-[100%] h-[80svh]" />
              </div>
              ...
              >
                {productData?.map((el: any, i: any) => (
                  ...
                  >
                    ...
                    <p className="text-lg font-semibold mt-2">Price:
                      <span className="text-green-500 text-md lg:text-[1.2vw] font-normal ml-5">
                        ${el.price}
                      </span>
                    </p>
                    <p className="text-lg font-semibold">Rating:
                      <span className=" text-md lg:text-[1.2vw] font-normal ml-2">
                        {el.rating.rate}
                      </span>
                    </p>
                    <p className="text-lg font-semibold">Category:
                      <span className="text-md lg:text-[1.2vw] font-normal ml-2">
                        {el.category}
                      </span>
                    </p>
                    <p className="text-lg font-semibold h-[10vh]" >
                      Title: 
                      <span className="text-md lg:text-[1.2vw] font-normal ml-2">
                        {el.title}
                      </span>
                    </p>
                    <div className="flex w-[50vw] md:w-full items-center m-auto justify-center mt-6 bg-[#3BD188] text-black font-semibold text-lg hover:bg-black hover:text-[#3BD188] rounded-2xl">
